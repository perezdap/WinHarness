...
public sealed class BuiltinToolProvider : IToolProvider
{
    ...
    private sealed class LocalCapturedCommandExecutor : CapturedCommandExecutorBase
    {
        ...
        {
            return new(new CommandResult(1, string.Empty, "Interactive command execution requires the Windows platform executor.", CommandExecutionMode.Interactive));
        }
    }
