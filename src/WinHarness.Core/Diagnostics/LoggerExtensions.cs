...
{
    [LoggerMessage(EventId = 1000, Level = LogLevel.Debug, Message = "Provider request starting for {ProviderId}/{ModelId}.")]
    public static partial void ProviderRequestStarting(this ILogger logger, string providerId, string modelId);

    [LoggerMessage(EventId = 1001, Level = LogLevel.Debug, Message = "Provider request completed for {ProviderId}/{ModelId}.")]
