...
{
    public static readonly Attribute DefaultText = new(Color.Gray, Color.Black);
    ...
    public static readonly Attribute SystemText = new(Color.Gray, Color.Black);
    public static readonly Attribute SystemRoleLabel = new(Color.Gray, Color.Black);
    public static readonly Attribute AssistantRoleLabel = new(Color.BrightBlue, Color.Black);
    public static readonly Attribute StatusText = new(Color.Gray, Color.Black);
    public static readonly Attribute Border = new(Color.Gray, Color.Black);
    ...
    public static readonly Attribute ToolText = new(Color.Gray, Color.Black);
