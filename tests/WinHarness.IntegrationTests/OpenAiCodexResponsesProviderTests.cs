...
public sealed class OpenAiCodexResponsesProviderTests
{
    ...
    public async Task SendsFunctionCallOutputOnToolFollowUp()
    {
        ...
        [
            ...
            [
                new FunctionCallContent("call_1|fc_1", "get_weather", new Dictionary<string, object?> { ["location"] = "SF" }),
            ]),
    ...
    private sealed class FakeCredentialStore : ICredentialStore
    {
        ...
        public ValueTask<IReadOnlyList<string>> ListTargetNamesAsync(CancellationToken cancellationToken)
            => ValueTask.FromResult<IReadOnlyList<string>>([OAuthCredentialNames.ForProvider(OpenAiCodexOAuthFlow.ProviderId)]);
    }
